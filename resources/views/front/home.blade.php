          ...
          <div id="myCarousel" class="carousel slide bg-dark" data-ride="carousel">
            ...
            <div class="carousel-inner bg-black  ">
                <div class="carousel-item  active">
                    <img src="{{asset('dist/img/1.jpg')}}" class="d-block img-fluid  "  alt="...">
                    </div>

                     <div class="carousel-item  ">
                                <img src="{{asset('dist/img/IMG_0034.PNG')}}" class="d-block img-thumbnail bg-opacity-50" alt="...">
                              </div>

                               <div class="carousel-item ">
                                <img src="{{asset('dist/img/2.jpg')}}" class="d-block img-fluid bg-opacity-75 " alt="...">
                              </div>
            ...
            <div class="swiper-slide  ">
                <div class="card card1 mb-4 shadow-sm">
                    <div class="card-body ">
                      ...
                      <img src="{{url('images', $dish->image)}}" class="card-img  w-100 h-50 " alt="card image cap">
    ...
    <div class="container">
        ...
        <div class="row">
         ...
         <div class="col-md-6 col-sm-12">
             <img src="{{asset('dist/img/melissia-suares-wvNGkJhsFjI-unsplash.jpg')}}" class="w-100 h-75" alt="">
             </div><!-- col-md-6 -->
             ...
             <div class="col-md-6">
                 ...
                 <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                     ...
                     <div class=" d-flex justify-content-around">
                         ...
                         <button class="btn btn-success text-bold d-block mt-3 mx-auto px-5">Learn More</button>
        ...
        <div class="swiper product-slider  ">
            ...
            <div class="swiper-wrapper ">
                ...
                <div class="swiper-slide box ">
                    <div class="card card2  mb-4 shadow-sm">
                        <div class="card-body text-center">
                            <img src="{{asset('dist/img/person3.jpg')}}" class="img-fluid rounded-circle w-50" alt="">
                 ...
                 <div class="swiper-slide box ">
                    <div class="card card2  mb-4 shadow-sm">
                        <div class="card-body text-center">
                            <img src="{{asset('dist/img/pic-3.png')}}" class="img-fluid rounded-circle w-50" alt="">
                ...
                <div class="swiper-slide box ">
                    <div class="card card2  mb-4 shadow-sm">
                        <div class="card-body text-center">
                            <img src="{{asset('dist/img/person4.jpg')}}" class="img-fluid rounded-circle w-50" alt="">
                    ...
                    <div class="swiper-slide box ">
                        <div class="card card2  mb-4 shadow-sm">
                            <div class="card-body text-center ">
                                <img src="{{asset('dist/img/person1.jpg')}}" class="img-fluid rounded-circle w-50 align-content-center" alt="">
